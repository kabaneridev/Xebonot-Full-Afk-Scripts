-----SETTINGS---------------------------------------------------------------
local Dring_DringID =  3097
local Dring_DringMax = 3
local DpBp_Dring = 3 -- 0-the first backpack in the depot, 1-second backpack in the depot, etc.
...
----------------------------------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------------------------------
  ...
  elseif (labelName == "TargetingOff") then 
		...
		wait(900, 1200)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
elseif (labelName == "Dring") then
    if (Self.ItemCount(Dring_DringID) < Dring_DringMax) then
        local DringNumber = (Dring_DringMax - Self.ItemCount(Dring_DringID))
        Self.WithdrawItems(DpBp_Dring, {Dring_DringID, 0, DringNumber})
    end
----------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    elseif (labelName == "Items") then
		...
		wait(1000)
		Self.ShopSellAllItems(10386)
		wait(1000)
		Self.ShopSellAllItems(10384)
		wait(1000)
		Self.ShopSellAllItems(10406)
		wait(1000)
                Self.ShopSellAllItems(10388)
		wait(1000)
                Self.ShopSellAllItems(10387)
		wait(1000)
		Self.SayToNpc({"bye"})
		setWalkerEnabled(true)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
