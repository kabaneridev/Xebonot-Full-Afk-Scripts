local CONFIG = {
    ...
    LIST = 
        {'mercenary sword', 'royal helmet', 'medusa shield', 'warrior helmet', 'terra mantle',
        'terra legs', 'guardian halbers',
        'zaoan sword', 'small topaz',
        'poisoned fang', 'minotaur horn', 'tower shield', 'knight armor',
        'stone skin amulet', 'titan axe', 'mooh\'tah shell', 'mooh\'tah plate', 'small sapphire', 'mino shield'}},
    {BP = 'camouflage', -- BP name or index
    LIST = 
        {'camouflage backpack', 'gold coin', 'strand of medusa hair', 'small emerald', 'snake skin', 'small sapphire', 'winged tail', 'life crystal'}}
}
