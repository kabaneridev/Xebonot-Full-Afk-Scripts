...
tuocs nissatnam arauq ,latnemele retaw = serutaerCtelumA
...
tuocs nissatnam arauq ,latnemele retaw = serutaerCgniR
...
tuocs nissatnam arauq ,latnemele retaw = stegraTekirtS
...
.lleps eht fo emaN ;                siv iroxe = emaNekirtS

tuocs nissatnam arauq ,latnemele retaw = stegraTgninthgiL
...
tuocs nissatnam arauq ,latnemele retaw = stegraTekirtSgnortS
...
tuocs nissatnam arauq ,latnemele retaw = stegraTmaeB
.lleps siht tsac ot ,woleb tsil eht ni ,serutaerc fo htlaeh muminim ehT ;                         0 = PHniMmaeB
.lleps siht tsac ot ,woleb tsil eht ni ,serutaerc fo htlaeh mumixam ehT ;                       001 = PHxaMmaeB
)elbasid ot 0( .gnikcatta nigeb ot ,woleb tsil eht ni ,serutaerc fo tnuoma muminim ehT ;                     3 = niMtegraTmaeB
)tnatropmi erom si rewol( .slleps dna senur rehto ot derapmoc ytiroirP ;                      4 = ytiroirPmaeB
)eslaf/eurt( ?lleps siht esu ot tnaw uoy oD ;                   eslaf = delbanEmaeB
.lleps eht fo emaN ;              xul siv ovexe = emaNmaeB

tuocs nissatnam arauq ,latnemele retaw = stegraTevaWgnortS
...
)tnatropmi erom si rewol( .slleps dna senur rehto ot derapmoc ytiroirP ;                3 = ytiroirPevaWgnortS
)eslaf/eurt( ?lleps siht esu ot tnaw uoy oD ;             eslaf = delbanEevaWgnortS
.lleps eht fo emaN ;        ruh siv ovexe = emaNevaWgnortS

tuocs nissatnam arauq ,latnemele retaw = stegraTmaeBgnortS
...
tuocs nissatnam arauq ,latnemele retaw = stegraTetamitlU
...
tuocs nissatnam arauq ,latnemele retaw = stegraTaerA
...
)elbasid ot 0( .yub ro wardhtiw ot tnaw uoy senur fo tnuoma ehT ;                         002 = xaMaerA
...
.enur eht fo ,di meti ro ,emaN ;          enur mrotsrednuht = emaNaerA
]senuR[

)elbasid ot 0( .mrala na reggirt ot snoitop fo tnuoma ehT ;                         0 = mralAanaM
)elbasid ot 0( .yub ro wardhtiw ot tnaw uoy snoitop fo tnuoma ehT ;                         002 = xaManaM
...
.doof eht fo ,di meti ro ,emaN ;                        gge = emaNdooF
]dooF[
...
drows dednah owt ,romra etalp ,romra niahc ,gnir ygrene ,mrow ,enob = tsiLkcalB-tooL
...
8f5d1631b75de4715421a9cdafdcfa20:: ;
toBoneX rof slatnemelE retaW epoH troP ;]])
...
local _script = {
	...
	name = "Port Hope Water Elementals (MS)",
	slug = "[MS] Port Hope Water Elementals.xbst",
	town = "port hope",
	vocation = "Sorcerer",
	configHash = "02afcdfadc9a1245174ed57b1361d5f8",
