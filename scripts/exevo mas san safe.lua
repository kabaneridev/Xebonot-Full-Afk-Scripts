...
attack = {}
attack[1] = {words="exevo mas san", min = 2, distance = 3, padding = 8, multFloor = true, needsTarget = true, ignoreParty = true}
attack[2] = {words="exevo mas san", min = 2, distance = 3, padding = 8, multFloor = true, needsTarget = true, ignoreParty = true}
attack[3] = {words="exevo mas san", min = 2, distance = 3, padding = 8, multFloor = true, needsTarget = true, ignoreParty = true}
