...
local MinMana = 30 --- How many mana potions until you leave the hunt.
...
local MaxAvalanche = 100 --- How many health potions you begin the hunt with.
...
local info = [[
MS MINOTAURS ORAMOND BY MATHIA]]
    print([[
MS MINOTAURS ORAMOND BY MATHIA]])
    wait(20000)
