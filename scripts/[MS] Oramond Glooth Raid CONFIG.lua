...
local MaxAvalanche = 1000 --- How many health potions you begin the hunt with.
...
local GoldBp  = "camuouflage backpack" ---- Backpack to put gold in
local PotionBp  = "golden backpack" ---- Potion Bp
