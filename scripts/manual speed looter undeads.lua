local CONFIG = {
    ...
    LIST = 
        ...
        'underworld rod', 'golden legs', 'ruthless axe', 'golden armor', 'haunted blade', 'divine plate', 'war axe', 'dragon slayer', 'terra boots', 'dreaded cleaver', 'skull staff', 'dreaded cleaver', 'Spellweaver/s robe', 'dragonbone staff', 'knight armor','mercenary sword'}},
    {BP = 'camouflage backpack', -- BP name or index
    LIST = 
        {'platinum coin', 'gold coin', 'demonic essence', 'hellspawn tail', 'soul orb', 'small sapphire', 'gold ingot', 'fur boots', 'unholy bone', 'small topaz', 'small emerald', 'small ruby', 'white pearl', 'black pearl', 'necromantic rust', 'giant shimmering pearl', 'boots of haste'}}
}
