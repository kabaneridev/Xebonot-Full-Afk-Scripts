...
local MinMana = 120 --- How many mana potions until you leave the hunt.
...
SkillClub = true --- Does your character use Club Fighting primarily? (ONLY PUT TRUE ON ONE!)
...
local info = [[
~~~~DARASHIA FERU QUEST 2017 PROFITANDO CASH MAKER BY GUCCI~~~~
]]
    print([[
~~~~DARASHIA FERU QUEST 2017 PROFITANDO CASH MAKER BY Gucci~~~~
]])
...
----------------------------------------------------------------------------------------------------
	...
	{281, 0}, 	-- winged tail
		{9058, 0}, 	-- winged tail
				{22728, 0}, 	-- small emerald
		{22730, 0}, 	-- strand of medusa hair
		{7414, 0}, 	-- snake skin 
		{22727, 1}, 	-- winged tail
		{22727, 1}, 	-- snake skin 
		{22726, 1}, 	-- winged tail
