...
local MinMana = 400 --- How many mana potions until you leave the hunt.
local MaxMana = 1400 --- How many mana potions you begin the hunt with.
...
local MaxHealth = 350 --- How many health potions you begin the hunt with.
...
local info = [[
~~~~MEDUSA TOWER BY MATHIA PRO VERSION WITH TASKER AND ITEM SELLER~~~~]]
    print([[
~~~~MEDUSA TOWER BY MATHIA PRO VERSION WITH TASKER AND ITEM SELLER~~~~]])
    wait(30000)
