...
local MaxHealth = 2200 --- How many health potions you begin the hunt with.
local HealthPrice = 190 --- What is the price of your selected mana potions?

local ArrowID = 6528 ---- Normal Spear ID is 3277 . Royal Spear ID is 7378
...
local MaxArrow = 2700 ---- Spear amount to refill too. 
...
--BP SETUP--
local MainBp  = "wolf backpack" ----- Main Backpack
...
local info = [[
~~~~INQ BATTLEFIELD INFERNAL BOLTS BY MATHIA 2018
]]
    print([[
~~~~INQ BATTLEFIELD INFERNAL BOLTS BY MATHIA 2018]])
    wait(30000)
...
----------------------------------------------------------------------------------------------------
   elseif (labelName == "DepositItems") then
   	...
   	{5906, 0}, 	-- spider silk
		...
		{6553, 1}, 	-- spider silk
		{3079, 1}, 	-- iron ore
		{3280, 1}, 	-- small emerald
		{821, 1}, 	-- strand of medusa hair
		{7427, 1}, 	-- snake skin 
		{3371, 1}, 	-- snake skin 
		{3071, 1}, 	-- royal helmet
		{10304, 0}, 	-- winged tail
		...
		{3340, 1}, 	-- ancient stone
		{3041, 1}, 	-- boots of haste
		{7421, 1}, 	-- boots of haste
		{3332, 1}, 	-- ancient stone
				{6528, 5}, 	-- ancient stone
