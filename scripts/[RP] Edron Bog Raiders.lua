...
)eslaf/eurt( ?lleps siht esu ot tnaw uoy oD ;                 eslaf = delbanESiroxE
.lleps eht fo emaN ;                nas iroxe = emaNSiroxE

rediar gob = stegraTsaMovexE
...
)elbasid ot 0( .yub ro wardhtiw ot tnaw uoy omma fo tnuoma ehT ;                          52 = xaMommA
...
)eslaf/modnar/eurt( .etuor sriatspu eht hguorht seunitnoc retcarahc eht rehtehW ;                      eslaf = sriatspU
]etuoR[

mrow ,enob ,sgel etalp = tsiLkcalB-tooL
...
c05bfe7a776a0fd54dfe15a607d0af95:: ;
toBoneX rof srediaR goB nordE ;]])
...
local _script = {
	...
	name = "Edron Bog Raiders (RP)",
	slug = "[RP] Edron Bog Raiders.xbst",
	town = "edron",
	vocation = "Paladin",
	configHash = "59fa0d706a51efd45df0a677a7efb50c",
