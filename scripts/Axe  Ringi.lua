-- Ring #1
local UseRing = true
local Ring = 3092 -- Item ID of the ring, with the most priority, that you want to equip. (Default: Ring of Healing)
local ActiveRing = 3092 -- Item ID of the ring while wearing it.
-- Ring #2
local UseRing2 = false
local Ring2 = 3052 -- Item ID of the ring, with least priority, that you want to equip. (Default: Life Ring)
local ActiveRing2 = 3089 -- Item ID of the ring while wearing it.
-- Alternate Ring
local AlternateRing = 3093 -- Item ID of your alternate ring. (Default: Wedding Ring)
