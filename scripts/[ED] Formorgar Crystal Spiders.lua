...
)cigam ,raeps ,bulc ,exa ,drows ,enon( .esu ot eutats gniniart ehT ;                   cigam = llikS-niarT
...
melog eci ,redips latsyrc = serutaerCtelumA
...
melog eci ,redips latsyrc = serutaerCgniR
...
)elbasid ot 0( .gnir eht piuqe ot htlaeh fo tnecrep ehT ;                       001 = PHniMgniR
)elbasid ot 0( .toped eht morf wardhtiw ot tnaw uoy sgnir fo tnuoma ehT ;                           3 = xaMgniR
)elbasid ot 0( .llifer og ot evael uoy hcihw ta sgnir fo tnuoma ehT ;                           0 = niMgniR
.gnir eht fo ,di meti ro ,emaN ;                  gnir emit = emaNgniR
]gniR[

melog eci ,redips latsyrc = stegraTekirtS
...
melog eci ,redips latsyrc = stegraTekirtSgnortS
...
melog eci ,redips latsyrc = stegraTevaW
.lleps siht tsac ot ,woleb tsil eht ni ,serutaerc fo htlaeh muminim ehT ;                         0 = PHniMevaW
.lleps siht tsac ot ,woleb tsil eht ni ,serutaerc fo htlaeh mumixam ehT ;                       001 = PHxaMevaW
)elbasid ot 0( .gnikcatta nigeb ot ,woleb tsil eht ni ,serutaerc fo tnuoma muminim ehT ;                     2 = niMtegraTevaW
)tnatropmi erom si rewol( .slleps dna senur rehto ot derapmoc ytiroirP ;                      2 = ytiroirPevaW
)eslaf/eurt( ?lleps siht esu ot tnaw uoy oD ;                   eslaf = delbanEevaW
.lleps eht fo emaN ;             ruh aret ovexe = emaNevaW

melog eci ,redips latsyrc = stegraTetamitlU
...
melog eci ,redips latsyrc = stegraTaerA
...
)tnatropmi erom si rewol( .slleps dna senur rehto ot derapmoc ytiroirP ;                      4 = ytiroirPaerA
...
.llifer og ot evael lliw uoy hcihw ta senur fo tnuoma ehT ;                          07 = niMaerA
)eslaf/eurt( ?enur siht esu ot tnaw uoy oD ;                   eslaf = delbanEaerA
.enur eht fo ,di meti ro ,emaN ;          enur mrotsrednuht = emaNaerA

redips latsyrc = stegraTelissiM
.lleps siht tsac ot ,woleb tsil eht ni ,serutaerc fo htlaeh muminim ehT ;                      0 = PHniMelissiM
...
.llifer og ot evael lliw uoy hcihw ta snoitop fo tnuoma ehT ;                          05 = niManaM
...
temleh egnarts ,temleh leets ,ebuc eci ,romra etalp ,sgel etalp = tsiLkcalB-tooL
kcapkcab dellewej ,klis redips ,sgel thgink ,romra thgink = tsiLetihW-tooL
)elbasid ot 0( .tool ot ,meti rep ,thgiew mumixam ehT ;                 001 = thgieW-xaM-tooL
...
ccc7b42c5c5648d2fee2d72a86ef841a:: ;
toBoneX rof sredipS latsyrC ragromroF ;]])
...
local _script = {
	...
	name = "Formorgar Crystal Spiders (ED)",
	slug = "[ED] Formorgar Crystal Spiders.xbst",
	town = "svargrond",
	vocation = "Druid",
	configHash = "a148fe68a27d2eef2d8465c5c24b7ccc",
