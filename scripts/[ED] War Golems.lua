...
local HealthID = 3302 --- Which health potions are you using?
...
--AUTOSELLING--
local sellingcrossbow = true --- Set this on true if you want to sell Double Axe and Steel Helmets.
--BP SETUP--
