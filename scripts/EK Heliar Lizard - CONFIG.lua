...
--BP SETUP--
local MainBp  = "expedition backpack" ----- Main Backpack
local GoldBp  = "blue backpack" ---- Backpack to put gold in
local LootBp  = "backpack" ---- Loot Bp
local PotionBp  = "fur backpack" ---- Potion Bp
-----END OF SETTINGS-------------------------------------------------------
-----DO NOT EDIT BELOW HERE IF YOU DONT KNOW WHAT TO DO--------------------

registerEventListener(WALKER_SELECTLABEL, "onWalkerSelectLabel")
local info = [[
EK HELIAR LIZARDS BY Gucci]]
    print([[
EK HELIAR LIZARDS BY Gucci]])
    wait(20000)
...
elseif (labelName == "UndeadsTask") then  
		Walker.Stop()
		wait(1500,2000)
		Self.SayToNpc("bye")
		wait(1500,2000)
