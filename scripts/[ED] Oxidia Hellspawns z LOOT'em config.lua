...
local GoldBP = "WPISZ TUTAJ PLECAK NA GP I STACKABLE ITEMY"
local LootBP = "WPISZ TUTAJ PLECAK LOOT"
...
local info = [[
OXIDIA HELLSPAWN DRUID BY Gucci]]
    print([[
OXIDIA HELLSPAWN DRUID BY Gucci]])
    wait(20000)
...
if (labelName == "Backpacks") then
            ...
            Self.OpenMainBackpack(true):OpenChildren({GoldBP, true},{LootBP, true},{SdBp, true})
		setWalkerEnabled(true) 
